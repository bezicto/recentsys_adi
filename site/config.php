...
$tokenaeskeysys = "insert_new_aes_key_here";
...
$licensed_info = "Your Institution Name";
...
//version 1.0.20260201.0922
    ...
    $enable_googlebookapi = false;
    $googlebook_api_key = "insert_googlebook_api_key"; // Optional: Google Books API Key (recommended to avoid unauthenticated HTTP 429 quota limits)
    $enable_openlibraryapi = true;

    //Polaris Integration Settings
    $enable_pnm_polaris_integration = false;
    $pnm_polaris_access_key = "insert_polaris_key";
    $pnm_polaris_access_id = "insert_polaris_id";
    $pnm_polaris_base_url = "https://insert_polaris_base_url/PAPIService/REST/public/v1/1033/1/1";
