<?php
if (empty($_SESSION['username_myacc'])) {
    $currentdir = substr(getcwd(), -5);
    $cssPath = ($currentdir == 'admin' || $currentdir == 'ports' || $currentdir == 'atics' || $currentdir == 'wsers') ? '../assets/styles/style.css' : './assets/styles/style.css';
